 ...
 */
/* char font[] = "Iosevka Slab:pixelsize=16:antialias=true:autohint=true"; */
char font[] = "Hack-Regular:pixelsize=16:antialias=true:autohint=true";
int borderpx = 2;
...
Shortcut shortcuts[] = {
	...
	{ TERMMOD,              XK_U,           externalpipe,   {.v =  "purls.py | dmenu -l 10 | xargs -r xdg-open"} },
};
